...
public class Urls {
    ...
    public static final String Login = "stu_login";
    public static final String BASE_URL = "http://abcd/";
    public static final String REQUEST_REQUEST= "request/";
    public static final String REQUEST_PROFESSOR= "professor/";

    public static final String REQUEST_INTERNSHIP= "internship/";
    ...
    public static final String BASE_URL = "http://abcd/";//have to be consulted
